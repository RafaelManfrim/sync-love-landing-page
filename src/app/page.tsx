    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden border-b py-20 md:py-32">
          <div className="absolute inset-0 bg-linear-to-br from-red-50 via-rose-50 to-background opacity-50" />
          <Container className="relative">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
                <Button size="lg" className="bg-linear-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700">
                ...
                <CardContent>
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-center">
                      <Star className="mr-2 h-4 w-4 text-red-500" fill="currentColor" />
          ...
          <Container>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="text-center">
                <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-linear-to-br from-red-500 to-rose-600 text-2xl font-bold text-white">
                  1
                </div>
        ...
        <section className="border-t py-20 md:py-32">
          <Container>
            <div className="mx-auto max-w-3xl text-center">
              <Heart className="mx-auto mb-6 h-16 w-16 text-red-500" fill="currentColor" />
              <h2 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl">
